...
public class NetworkTransform : NetworkComponent
{
    ...
    void Update()
    {
        if(IsClient)
        {
            ...
            {
                this.transform.position = Vector3.Lerp(this.transform.position, LastPosition, 3.5f * Time.deltaTime);
                this.transform.rotation = Quaternion.Euler(Vector3.Lerp(this.transform.rotation.eulerAngles, LastRotation, 120 * Time.deltaTime));
            }
        }
    }
}
